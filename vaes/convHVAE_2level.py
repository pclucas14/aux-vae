...
from utils.nn import he_init, GatedDense, NonLinear, Conv2d, GatedConv2d, GatedConv2dBN, GatedResUnit 
from utils.nn import ResizeGatedConv2d, MaskedConv2d, ResUnitBN, ResizeConv2d, GatedResUnit, GatedConvTranspose2d
...
class VAE(Model):
    def __init__(self, args):
        ...
        if self.args.dataset == 'freyfaces':
            h_size = 210
        ...
        self.q_z2_layers = nn.Sequential(
            GatedConv2d(self.args.input_size[0], 32, 7, 1, 3),
            GatedConv2dBN(32, 32, 3, 2, 1),
            GatedConv2dBN(32, 64, 5, 1, 2),
            GatedConv2dBN(64, 64, 3, 2, 1),
            GatedConv2dBN(64, 6, 3, 1, 1)
        )
        # linear layers
    ...
    def p_x(self, z1, z2):
        ...
        return x_mean.view(*h.size()), x_logvar.view(*h.size())
